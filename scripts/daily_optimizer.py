...
def main():
    ...
    L.append("")
    L.append("⏸️ 等接入后才能做的「真优化」(待 Jack 给凭证):")
    L.append("• 写 SEO 长文(主题池 60 题,需要 LLM 凭证)")
    L.append("• 改 meta title/description 优化 CTR(需要 GSC API 看哪些词点击率低)")
    L.append("• 内链结构优化(需要 site graph 分析)")
